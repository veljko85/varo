      ...
      return this.each(function () {
        ...
        priceBut.onclick = () => {
          if (cartPricesLoaded[0]) {
            ...
            let varo180180LarcheCart = 0;
            let varo90180LarcheCart = 0;

            for (let i = 0; i < allFences.length; i++) {
              // if (fencesArr[i].color == "grau") {
              if (allFences[i][0].isVisible) varo180180LarcheCart += 1;
              if (allFences[i][1].isVisible) varo90180LarcheCart += 1;
